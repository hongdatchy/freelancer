...
export default function Course() {
  return (
    <div className="bg-white text-gray-800 font-sans">
      ...
      <section className="py-10 px-6 md:px-16 lg:px-24 bg-[#2E357F] text-white relative" data-purpose="course-hero">
            ...
            <div className="w-full xl:w-[40%] flex flex-col items-center xl:items-end justify-center">
              <div className="w-full max-w-[560px] flex flex-col items-center">
                ...
                <div className="bg-white rounded-[32px] p-5 shadow-2xl text-slate-800 mb-5 w-full">
                  <p className="text-sm md:text-base leading-relaxed text-[#2E357F] font-semibold text-justify">
                ...
                <div className="w-full flex justify-center">
                  <a
                    href="#trial-section"
                    className="inline-block bg-[#3F489A] hover:bg-[#252a60] text-white font-extrabold py-4 px-12 rounded-full shadow-lg transition-transform hover:scale-105 text-base tracking-wider text-center border-2 border-[#2E357F]"
                  >
                    Học thử miễn phí
                  </a>
                </div>
