        ...
        <main className="mx-auto w-full max-w-[1440px] px-6 md:px-10 lg:px-12 relative z-10 text-[#24389c]">
          ...
          <article className="policy-container bg-white rounded-xl p-8 md:p-12 text-[#24389c]">
            ...
            <section className="mb-8">
              ...
              <div className="pl-6 section-desc !font-medium">
                ...
                <ul className="space-y-2 list-none pl-4">
                  ...
                  <li className="list-item">Nội dung và hình thức dịch vụ có thể được điều chỉnh để phù hợp với từng giai đoạn phát triển.</li>
                </ul>
              </div>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="pl-6 space-y-4 section-desc !font-medium">
                <div>
                  <p className="!font-bold mb-2">Quyền của Vietsure:</p>
                  <ul className="space-y-2 list-none pl-4">
                ...
                <div>
                  <p className="!font-bold mb-2">Trách nhiệm:</p>
                  <ul className="space-y-2 list-none pl-4">
            ...
            <section className="mb-8">
              ...
              <div className="pl-6 space-y-4 section-desc !font-medium">
                <div>
                  <p className="!font-bold mb-2">Quyền của phụ huynh/học viên:</p>
                  <ul className="space-y-2 list-none pl-4">
            ...
            <section className="mb-8">
              ...
              <div className="pl-6 section-desc !font-medium">
                <ul className="space-y-2 list-none pl-4">
                  ...
                  <li className="list-item">Vietsure English cung cấp nhiều hình thức thanh toán (chuyển khoản, tiền mặt, trả góp 0%).</li>
                  <li className="list-item">Trong trường hợp học viên có nhu cầu dừng học, việc hoàn học phí sẽ tuân thủ theo <a href="/faq" className="hover:underline !font-bold">Chính sách hoàn học phí</a> của chúng tôi.</li>
                </ul>
              </div>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="pl-6 section-desc !font-medium">
                <p className="!font-bold mb-2">Người dùng cam kết:</p>
                <ul className="space-y-2 list-none pl-4">
            ...
            <section className="mb-8">
              ...
              <div className="pl-6 section-desc !font-medium">
                <p className="mb-2">Tất cả nội dung trên website và trong khóa học thuộc quyền sở hữu của Vietsure English, bao gồm:</p>
                ...
                <p className="!font-bold">Nghiêm cấm sao chép, sử dụng lại khi chưa có sự cho phép.</p>
              </div>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="pl-6 section-desc !font-medium">
                <p className="!font-bold mb-2">Vietsure English không chịu trách nhiệm trong các trường hợp:</p>
                <ul className="space-y-2 list-none pl-4">
