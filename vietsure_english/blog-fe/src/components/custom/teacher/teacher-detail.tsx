    ...
    <div className="md:col-span-3 w-full">
      <section className="px-6 py-20 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 relative">
          ...
          <div className="flex-1 bg-[#3F489A] rounded-[36px] p-8 md:p-12 md:pt-20 flex flex-col md:flex-row gap-16 md:gap-10 items-stretch relative shadow-[0_15px_40px_rgba(59,130,246,0.15)]">
